    ...
    <div className="isolate bg-black px-6 py-24 sm:py-32 lg:px-8">
        ...
        <form onSubmit={ContactCreate} method="POST" className="mx-auto max-w-xl sm:mt-10">
            ...
            <div className="sm:col-span-2">
                ...
                <div className="mt-2.5">
                <input value={phone} onChange={e=>setPhone(e.target.value)}  type="tel" name="phone" id="phone" placeholder='+959' autoComplete="phone" className="block w-full rounded-md border-0 px-3.5 py-2 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                </div>
            </div>
            <div className="sm:col-span-2">
                <label htmlFor="phone" className="block text-sm font-semibold leading-6 text-white">Whatsapp</label>
                <div className="mt-2.5">
                <input value={whatsapp} onChange={e=>setWhatsapp(e.target.value)}  type="tel" name="phone" id="phone" placeholder='+959' autoComplete="phone" className="block w-full rounded-md border-0 px-3.5 py-2 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                </div>
            </div>
            <div className="sm:col-span-2">
